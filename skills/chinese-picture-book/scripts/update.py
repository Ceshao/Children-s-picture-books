#!/usr/bin/env python3
"""Self-update the chinese-picture-book skill from GitHub.
...
BRANCH = "main"
SKILL_SUBPATH = "skills/chinese-picture-book"

# .../skills/chinese-picture-book  (this file is in .../scripts/update.py)
